            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-muted-foreground">
                        ...
                        , Bootstrap y Tailwindcss. En la actualidad me encuentro enfocado en tecnologías
                        modernas como <strong>Next.js</strong>, <strong>React</strong> ,{" "}
                        <strong>MongoDB</strong> y mejorar mis habilidades de <strong>JavaScript</strong>, con el objetivo de construir soluciones
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
                        ...
                        <a
                            href="public/proyectos/TobiasAlfonsoCV.pdf"
                ...
                <div className="grid grid-cols-1 gap-6">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <p className="text-muted-foreground">
                            ...
                            mantenimiento de bases relacionales como PostgreSQL, SQL
                            Server y exploracion en MongoDB.
                        </p>
                        </div>
                    </div>
                    </div>
